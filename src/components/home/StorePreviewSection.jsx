...
export default function StorePreviewSection() {
  ...
  return (
    <section id="store" className="py-24 lg:py-32 bg-[#F8FAFC] section-rule relative overflow-hidden">
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#1E3A5F]/6 to-transparent rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1E3A5F]/10 border border-[#1E3A5F]/20 mb-5">
              <ShoppingBag className="w-3.5 h-3.5 text-[#1E3A5F]" />
              <span className="font-inter text-xs font-semibold text-[#1E3A5F] tracking-wider uppercase">Solar Store</span>
            </div>
            <h2 className="font-jakarta font-extrabold text-[#0F172A] text-3xl lg:text-5xl leading-tight tracking-tight">
              ...
              <span className="text-[#1E3A5F]">Honest Prices</span>
            </h2>
          ...
          <Link
            to="/store"
            className="flex items-center gap-2 px-5 py-3 rounded-full bg-white border border-[#E2E8F0] text-[#1E3A5F] font-jakarta font-semibold text-sm hover:border-[#1E3A5F]/40 hover:shadow-md transition-all whitespace-nowrap self-start sm:self-end"
          >
